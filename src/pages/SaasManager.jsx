                        ...
                        {tenants.map(tenant => (
                            <article key={tenant.id} style={{ ...panelStyle, opacity: tenant.active ? 1 : 0.65 }}>
                                ...
                                <div style={{ display: 'flex', gap: '0.6rem', flexWrap: 'wrap', marginTop: '1rem' }}>
                                    <a className="btn-outline" href={`${window.location.origin}${import.meta.env.BASE_URL}?loja=${tenant.storeSlug}`} target="_blank" rel="noreferrer"><ExternalLink size={16} /> Abrir</a>
